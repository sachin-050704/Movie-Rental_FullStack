...
const MovieDetail5 = ({ movies }) => {

    const { platforms, crews } = movies;
    console.log(movies.rental)
        ...
        <>
            <div className="w-full h-full text-white bg-[#1A1A1A] p-3 rounded-xl">
                ...
                <div>
                    ...
                    <h5 className="py-3">{movies.mov_year}</h5>
                </div>
                ...
                <div>
                    ...
                    <button className="bg-black px-2 py-1.5 my-3">{movies.mov_year}</button>
                </div>
                ...
                <div>
                    ...
                    <button className="bg-black px-2 py-1.5 my-3">{movies.mov_genre}</button>
                </div>
                ...
                {movies?.rentals?.length === 0 ? <div className="py-2" onClick={() => handlePayment("movie",movies.id)}>
