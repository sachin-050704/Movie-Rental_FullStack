...
const Review = ({ id }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await axios.post("http://127.0.0.1:8000/movies/add_review/", formData);
                ...
                {open && (
                    <div>
                        <form
                            ...
                            className={`w-full h-full max-w-md backdrop-blur-xl bg-white/10  p-8 rounded-2xl shadow-2xl space-y-6 ${classes.revform}`}
                            style={{ overflow: "hidden", padding: "20px", justifySelf: "center" }}
                        >
                            ...
                            <div className="w-50 m-auto pt-3 rounded-2xl overflow-hidden text-white xs:w-full">
                                <button
                                    type="submit"
